namespace GigueService.Migrations
{
    ...
    public partial class updateIds2 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        SpokenLanguageId = c.Int(nullable: false, identity: true),
                        Language = c.String(),
                        Musician_MusicianId = c.Int(),
                    })
                .PrimaryKey(t => t.SpokenLanguageId)
                .ForeignKey("dbo.Musicians", t => t.Musician_MusicianId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        MusicianId = c.Int(nullable: false),
                        SpokenLanguageId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.MusicianId, t.SpokenLanguageId })
                .ForeignKey("dbo.Musicians", t => t.MusicianId, cascadeDelete: true)
                .ForeignKey("dbo.SpokenLanguages", t => t.SpokenLanguageId, cascadeDelete: true)
                .Index(t => t.MusicianId)
                .Index(t => t.SpokenLanguageId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MusicianLanguages", "SpokenLanguageId", "dbo.SpokenLanguages");
            ...
            DropIndex("dbo.MusicianLanguages", new[] { "SpokenLanguageId" });
